 ...
 * @endcode
 */
$settings['hash_salt'] = 'z3kv655e9qn6wn6tv0gs';
...
/**
 * Load Pantheon specific configuration when Pantheon env variable is defined.
 */
if (isset($_ENV['PANTHEON_ENVIRONMENT']) && file_exists($app_root . '/' . $site_path . '/settings.pantheon.php')) {
